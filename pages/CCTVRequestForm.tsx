      ...
      <form className="glass-panel p-8 rounded-[2rem] shadow-xl space-y-8 border border-white/60 dark:border-white/10">
        <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                <div className="md:col-span-5">
                    ...
                    <input type="text" className="w-full bg-white/50 dark:bg-white/5 border border-gray-200 dark:border-slate-700 rounded-xl py-3 px-4 outline-none focus:ring-2 focus:ring-red-500/20 text-slate-800 dark:text-white" value={formData.lastName} onChange={e => handleChange('lastName', e.target.value)} />
                </div>
                <div className="md:col-span-5">
                    <label className="block text-sm font-bold text-gray-700 dark:text-slate-300 mb-1 ml-1">First Name</label>
                    <input type="text" className="w-full bg-white/50 dark:bg-white/5 border border-gray-200 dark:border-slate-700 rounded-xl py-3 px-4 outline-none focus:ring-2 focus:ring-red-500/20 text-slate-800 dark:text-white" value={formData.firstName} onChange={e => handleChange('firstName', e.target.value)} />
                </div>
                <div className="md:col-span-2">
                    <label className="block text-sm font-bold text-gray-700 dark:text-slate-300 mb-1 ml-1">M.I.</label>
                    <input type="text" maxLength={2} className="w-full bg-white/50 dark:bg-white/5 border border-gray-200 dark:border-slate-700 rounded-xl py-3 px-4 outline-none focus:ring-2 focus:ring-red-500/20 text-slate-800 dark:text-white" value={formData.middleInitial} onChange={e => handleChange('middleInitial', e.target.value)} />
                </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div className="md:col-span-1">
                    ...
                    <input type="text" className="w-full bg-white/50 dark:bg-white/5 border border-gray-200 dark:border-slate-700 rounded-xl py-3 px-4 outline-none focus:ring-2 focus:ring-red-500/20 text-slate-800 dark:text-white" value={formData.street} onChange={e => handleChange('street', e.target.value)} />
                </div>
        ...
        <section>
            ...
            <div className="mt-4">
                ...
                <input type="text" className="w-full bg-white/50 dark:bg-white/5 border border-gray-200 dark:border-slate-700 rounded-xl py-3 px-4 outline-none focus:ring-2 focus:ring-red-500/20 text-slate-800 dark:text-white" value={formData.others} onChange={e => handleChange('others', e.target.value)} />
            </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div className="relative" onClick={(e) => openPicker(e, dateInputRef)}>
                        ...
                        <input ref={dateInputRef} type="date" className="w-full bg-white/50 dark:bg-white/5 border border-gray-200 dark:border-slate-700 rounded-xl py-3 pl-10 pr-4 outline-none focus:ring-2 focus:ring-red-500/20 text-slate-800 dark:text-white font-medium cursor-pointer" value={formData.dateOfIncident} onChange={e => handleChange('dateOfIncident', e.target.value)} />
                    </div>
                </div>
                <div>
                ...
                <div className="md:col-span-2">
                    ...
                    <input type="text" className="w-full bg-white/50 dark:bg-white/5 border border-gray-200 dark:border-slate-700 rounded-xl py-3 px-4 outline-none focus:ring-2 focus:ring-red-500/20 text-slate-800 dark:text-white" value={formData.placeOfIncident} onChange={e => handleChange('placeOfIncident', e.target.value)} />
                </div>
                <div className="md:col-span-2">
                    <label className="block text-sm font-bold text-gray-700 dark:text-slate-300 mb-1 ml-1">Purpose of Request</label>
                    <textarea className="w-full bg-white/50 dark:bg-white/5 border border-gray-200 dark:border-slate-700 rounded-xl py-3 px-4 outline-none focus:ring-2 focus:ring-red-500/20 h-24 resize-none text-slate-800 dark:text-white" value={formData.purpose} onChange={e => handleChange('purpose', e.target.value)} />
                </div>
            </div>
        </section>
